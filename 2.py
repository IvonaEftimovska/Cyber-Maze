...
while running:
    ...
    # ---------------- PAUSED ----------------
        ...
        screen.blit(BIG_FONT.render("PAUSED", True, WHITE),
                    (WIDTH // 2 - 120, 200))
        # Resume
        draw_neon_button(screen, resume_button, GREEN, "Resume", FONT)
        # Restart
        draw_neon_button(screen, resume_button, GREEN, "Restart Level", FONT)
        # Main Menu
        draw_neon_button(screen, resume_button, GREEN, "Main Menu", FONT)
    ...
    # ---------------- LEVEL RESULT ----------------
        ...
        draw_neon_button(screen, gameover_restart_button, GREEN, "Restart Game", FONT)

        pygame.draw.rect(screen, RED, gameover_quit_button, border_radius=12)

        draw_neon_button(screen, gameover_quit_button, RED, "Quit", FONT)
